$(function () {
  ...
  $('aside #aside_button1').click(function () {
    $(this).css({ 'display': 'none', 'top': "638px" });
  ...
  $('aside #aside_button2').click(function () {
    $(this).css({ 'display': 'none', 'top': '98px' });
  ...
  $('aside #aside_item1 .aside_icon').hover(function () {
    ...
    //   .attr('src', $(this).find('img').attr('src').replace('_white.png', '_hover.png'))
    //   .stop()
    //   .animate({
    //     opacity: 1
    //   }, 300)
    ...
    //   .attr('src', $(this).find('img').attr('src').replace('_hover.png', '_white.png'))
    //   .stop()
    //   .animate({
    //     opacity: 1
    //   }, 300)
